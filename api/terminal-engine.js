...
{"ideas":[{"pair":"EUR/USD","direction":"BUY|SELL","entry_zone":"1.1440-1.1455","tp":"1.1520","sl":"1.1400","lots":"0.05","horizon":"one-day (close within 24h)","conviction":"LOW|MED|HIGH","thesis":"...","risks":"...","sizing_note":"why THIS lot size: the margin arithmetic, projected margin level if taken, and what capped or freed the size","correlation_note":"..."}],"stand_down":false,"desk_note":"one-paragraph read of the session"}`;
...
${calLines(cal)}
Fresh wire:\n${digest(news, 14)}
Write a TIGHT morning briefing, telegram style, clipped, zero filler. HARD LIMITS: headline max 8 words; each position read max 18 words; pick only the 3-4 calendar events that actually matter to this book, each "what" max 8 words and "why" max 10 words; overall max 30 words naming tonight's single priority.
JSON only: {"headline":"...","lines":[{"pair":"EURUSD","read":"..."}],"calendar":[{"when":"Mon 21:00 BKK","what":"USD ISM Services (fc 54.2)","why":"beat = USD bid, hits the long"}],"overall":"..."}`, 1200);
    if (morningNote) {
