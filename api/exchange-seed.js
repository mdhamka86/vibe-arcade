...
//
// NOTE: tickers here are the REAL exchange symbols (MRVL, NTAP), not the display names the
// NOVA screenshot showed. A name where a symbol belongs resolves on no price feed, and it
// also breaks identity matching on every sync, which silently wipes locked levels.
//
...
export const SEED_BOOK = {
  ...
  holdings: [
    ...
    { id: 'seed_mrvl', ticker: 'MRVL', name: 'Marvell Technology Group', assetClass: 'CFD', leveraged: true, exchange: 'NASDAQ', qty: 1, avgCost: 285.19, lastPrice: 223.84, unrealised: -63.07, mentalTP: null, mentalSL: null },
    { id: 'seed_netapp', ticker: 'NTAP', name: 'NetApp Inc', assetClass: 'CFD', leveraged: true, exchange: 'NASDAQ', qty: 2, avgCost: 182.97, lastPrice: 163.47, unrealised: -41.09, mentalTP: null, mentalSL: null },
